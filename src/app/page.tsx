...
function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-12 lg:py-0">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[color:var(--winey-card-tan)]/60 border border-[color:var(--winey-border)] mb-6">
            ...
            <p className="mt-8 text-lg sm:text-xl text-[color:var(--winey-muted)] max-w-xl mx-auto lg:mx-0 leading-relaxed">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link href="/host/setup">
                <Button className="btn-shine w-full sm:w-auto h-14 px-8 text-lg font-semibold shadow-[var(--winey-shadow-sm)] hover:shadow-[var(--winey-shadow-lg)] hover:translate-y-[-2px] transition-all duration-300">
                  Host a Tasting
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link href="/player/join">
                <Button variant="neutral" className="w-full sm:w-auto h-14 px-8 text-lg font-semibold border-2 hover:bg-[color:var(--winey-card-tan)] transition-all duration-300">
                  Join Game
                </Button>
              </Link>
            </div>
            ...
            {/* Social proof hint */}
            <div className="mt-12 flex items-center justify-center lg:justify-start text-sm text-[color:var(--winey-muted)]">
          ...
          <motion.div 
            className="relative h-[500px] sm:h-[600px] lg:h-[680px] flex items-center justify-center"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              <motion.div 
                className="absolute w-[130px] sm:w-[170px] lg:w-[210px] z-10 left-[8%] sm:left-[5%] lg:left-[0%] top-[18%] sm:top-[15%] lg:top-[12%]"
                style={{ rotate: '-8deg' }}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                ...
                >
                  <Image
                    ...
                    className="drop-shadow-[0_8px_30px_rgba(0,0,0,0.12)]"
                  />
                </motion.div>
              </motion.div>
              ...
              <motion.div 
                className="absolute w-[180px] sm:w-[240px] lg:w-[290px] z-30 left-1/2 -translate-x-1/2 top-[5%] sm:top-[2%] lg:top-[0%]"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              <motion.div 
                className="absolute w-[130px] sm:w-[170px] lg:w-[210px] z-10 right-[8%] sm:right-[5%] lg:right-[0%] top-[18%] sm:top-[15%] lg:top-[12%]"
                style={{ rotate: '8deg' }}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
      ...
      <motion.div 
        ...
        aria-hidden="true"
      >
        <ChevronDown className="w-8 h-8 text-[color:var(--winey-muted)]" />
      </motion.div>
    </section>
  );
}
    ...
    <section className="py-24 px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="font-serif text-4xl sm:text-5xl font-semibold text-[color:var(--winey-muted-2)]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <motion.div
              key={feature.title}
              className="group relative p-6 rounded-2xl bg-white border border-[color:var(--winey-border)] hover:border-[color:var(--winey-title)]/30 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-[color:var(--winey-muted-2)] mb-2">{feature.title}</h3>
              <p className="text-[color:var(--winey-muted)] text-sm leading-relaxed">{feature.description}</p>
            </motion.div>
          ))}
        </div>
      </div>
...
function HowItWorks() {
  ...
  return (
    <section ref={containerRef} className="relative">
      ...
      <div className="pt-20 pb-10 px-6 lg:px-8">
        <motion.div 
          ...
          transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
        >
          <h2 className="font-serif text-5xl sm:text-6xl lg:text-7xl font-semibold text-[color:var(--winey-muted-2)]">
            Here's How It Works
          </h2>
        </motion.div>
      </div>
      ...
      <div className="relative min-h-[400vh]">
        {/* Sticky container for phone and content */}
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div className="relative w-[240px] sm:w-[280px] lg:w-[320px]">
                  <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      {/* Secondary phone - subtle, offset, positioned higher to show more */}
                      {GAME_STEPS[activeStep].imageAlt && (
                        <motion.div 
                          className="absolute -right-12 sm:-right-16 lg:-right-24 -top-8 sm:-top-12 lg:-top-16 w-[130px] sm:w-[160px] lg:w-[200px] -z-10"
              ...
              <div className="order-2 lg:order-2 text-center lg:text-left">
                  ...
                  {GAME_STEPS.map((_, index) => (
                    <button
                      ...
                      className={`h-1.5 rounded-full transition-all duration-500 ${
                        index === activeStep 
                          ? 'w-8 bg-[color:var(--winey-title)]' 
                          : index < activeStep 
                            ? 'w-3 bg-[color:var(--winey-title)]/40'
                            : 'w-3 bg-[color:var(--winey-muted)]/20'
                      }`}
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="mb-2">
                      <span className="font-serif text-8xl sm:text-9xl lg:text-[10rem] font-bold text-[color:var(--winey-title)]/15">
                        {GAME_STEPS[activeStep].step}
                      </span>
                    </div>
                    <h3 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-semibold text-[color:var(--winey-muted-2)] mb-6 -mt-14 lg:-mt-20 relative">
                      {GAME_STEPS[activeStep].title}
                    </h3>
                    <p className="text-lg sm:text-xl text-[color:var(--winey-muted)] leading-relaxed max-w-lg mx-auto lg:mx-0">
                ...
                {/* Step counter */}
                <div className="mt-8 text-sm text-[color:var(--winey-muted)]/60 font-medium tracking-wide">
...
function FinalCTA() {
  return (
    <section className="py-32 px-6 lg:px-8 relative overflow-hidden bg-[color:var(--winey-muted-2)]">
      {/* Subtle gradient overlay */}
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-0 left-1/4 w-[500px] h-[500px] rounded-full bg-[color:var(--winey-title)] blur-[150px]" />
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] rounded-full bg-[color:var(--winey-danger)] blur-[120px]" />
      </div>
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
      >
        <h2 className="font-serif text-5xl sm:text-6xl lg:text-7xl font-semibold text-white leading-tight">
          Your move, sommelier.
        </h2>
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/host/setup">
            <Button className="btn-shine h-16 px-10 text-xl bg-[color:var(--winey-title)] text-white hover:bg-[color:var(--winey-title)]/90 border-none shadow-[var(--winey-shadow-lg)] font-semibold">
              Start Hosting
...
function Footer() {
  return (
    <footer className="py-12 px-6 border-t border-[color:var(--winey-border)] bg-white">
      <div className="mx-auto max-w-7xl flex flex-col items-center gap-4">
        <div className="flex items-center gap-2">
          <span className="text-2xl">🍷</span>
          <span className="font-semibold tracking-widest text-[color:var(--winey-muted-2)]">WINEY</span>
        </div>
        
        <p className="text-sm text-[color:var(--winey-muted)]">
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[color:var(--background)] text-[color:var(--foreground)] selection:bg-[color:var(--winey-title)] selection:text-white">
      ...
      {/* Fixed Navigation */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'py-3 bg-[color:var(--background)]/95 backdrop-blur-xl border-b border-[color:var(--winey-border)]' : 'py-5 bg-transparent'}`}>
        <div className="mx-auto max-w-7xl px-6 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-2xl">🍷</span>
            <span className="font-semibold tracking-widest text-[color:var(--winey-muted-2)]">WINEY</span>
          </div>
          <span className="hidden sm:block font-serif italic text-sm text-[color:var(--winey-muted)]">By Maxim Kalinkin</span>
          <div className="flex items-center gap-3">
            <Link href="/player/join">
              <Button variant="neutral" size="sm" className="hidden sm:inline-flex">Join Game</Button>
            </Link>
            <Link href="/host/setup">
              <Button size="sm">Host Tasting</Button>
            </Link>
          </div>
        </div>
      </nav>
