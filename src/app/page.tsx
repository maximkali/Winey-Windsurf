      ...
      <main className="pt-10">
        ...
        <div className="mt-16 grid grid-cols-1 gap-10 text-center md:grid-cols-4">
          <div className="mx-auto max-w-[180px]">
            ...
            <p className="mt-2 text-[12px] text-[color:var(--winey-muted)]">Try 3 to 4 mystery wines each round – no labels, just taste and instinct</p>
          </div>
          <div className="mx-auto max-w-[180px]">
            <div className="text-[22px]">🔢</div>
            <p className="mt-2 text-[14px] font-semibold">Live Ranking</p>
            <p className="mt-2 text-[12px] text-[color:var(--winey-muted)]">Think you can price them right? Stack each wine from luxe to low-end</p>
          </div>
          <div className="mx-auto max-w-[180px]">
            <div className="text-[22px]">✅</div>
            <p className="mt-2 text-[14px] font-semibold">Smart Scoring</p>
            <p className="mt-2 text-[12px] text-[color:var(--winey-muted)]">Once everyone votes, see how your picks stacked up against your friends</p>
          </div>
          <div className="mx-auto max-w-[180px]">
            <div className="text-[22px]">🏆</div>
            <p className="mt-2 text-[14px] font-semibold">Compete &amp; Win</p>
            <p className="mt-2 text-[12px] text-[color:var(--winey-muted)]">Top taster takes the crown. Bragging rights (and maybe a hangover) await</p>
          </div>
        </div>
      </main>
    </WineyShell>
